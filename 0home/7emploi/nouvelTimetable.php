...
<form method="POST" action="./admin/emploi/store" accept-charset="UTF-8" class="col-md-12" id="myForm" data-toggle="validator" novalidate="true"><input name="_token" type="hidden" value="IHjEdJmN4XWQMmw79osOMDRXJdmUhQebt5Z48F02">
        ...
        <div class="col-md-6">
              <div class="form-group">
                ...
                <?php
                  ...
                  //Recuperer tous les les attribut du table class...
                  $ins=$base->pepare("SELECT * FROM classe ");
                  $ins->execute();
  
                  // inserer nom de la salle de classe
                  $get_nom_class = $base->prepare("SELECT nom_class FROM `classe` WHERE id_class = ?");

                  //Une Boucle Parcourir la table NOM_CLASS
                  while($result=$ins->fetch()) {

                    //Recuperer variable matiere dans le table classe:
                    $get_nom_class->execute(array($result['id']));
                    $nom_class = $get_nom_class->fetch()[0];
              ...
              <div class="form-group">
                ...
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                  <select name="teacher" class="form-control input-lg">
                    <option value="">select</option>
                      <?php
                          require("../config_PDO"); //CONNECTING DATA
                      ...
                      ?>
                        <option value="<?php echo $result['nom_prenom'];  ?>"><?php $result['nom_prenom'];  ?></option>
                      <?php
