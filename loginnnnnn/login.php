<!DOCTYPE html>
<!-- saved from url=(0037)https://dabach.co.ma/easyschool/login -->
...
<div class="col-md-6 col-md-offset-3">
  ...
  <div class="col-md-8 col-md-offset-2" style="padding: 20px 20px;">
    <a href="https://dabach.co.ma/easyschool"><img src="./login_files/logo.png" class="img-responsive" alt=""></a>
  </div>
  <div class="clear"></div>
...
<div class="clear" style="margin-top: 20px;"></div>
    ...
    <form method="POST" action="https://dabach.co.ma/easyschool/check" accept-charset="UTF-8" id="login">
  ...
  function parents(){
   ...
   $(document).on('click', '.btn4', function(){ parents(); });
            ...
            <div class="pull-right">
              <a href="https://dabach.co.ma/easyschool/password/reset">Forgot your password ?</a>
            </div>
